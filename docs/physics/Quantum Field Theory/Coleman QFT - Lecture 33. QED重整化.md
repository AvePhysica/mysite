...
在上一章[[Coleman QFT - Lecture 32. 生成泛函与Green函数]]中，我们得到了Ward identity：
$$
...
证明将采用归纳法，由五步完成。BPHZ程序可参见[[Coleman QFT - Lecture 25. 处理无限大：正规化与重整化]]。
...
我们要求截断也是规范不变的，这样生成形式上规范不变的反项。我们将讨论[[Coleman QFT - Lecture 25. 处理无限大：正规化与重整化]]中的两种正规化手段。
### 维数正规化
